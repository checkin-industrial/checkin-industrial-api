...
/// <summary>
/// Validator FluentValidation para DTOEmpresaCriar. Convive com Data Annotations
/// (que ja documentam restrições no OpenAPI/Swagger); aqui ficam as regras de
/// dominio e mensagens em pt-BR padronizadas.
/// </summary>
public sealed class DTOEmpresaCriarValidator : AbstractValidator<DTOEmpresaCriar>
{
    public DTOEmpresaCriarValidator()
    {
        RuleFor(e => e.Cnpj)
