...
public sealed class DTOPontoInstitucionalAtualizarValidator : AbstractValidator<DTOPontoInstitucionalAtualizar>
{
    public DTOPontoInstitucionalAtualizarValidator()
    {
        RuleFor(p => p.Nome)
